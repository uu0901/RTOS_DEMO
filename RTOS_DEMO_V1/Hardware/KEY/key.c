...
void Key_Init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_14 | GPIO_Pin_6;      //ROCK1_KEY
...
{
    if (GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_14) == 0) //ROCK1_KEY按下
    {
        return PRESS_ROCK1_KEY;
    }
    // if (GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_6) == 0) //ROCK2_KEY按下
    // {
